 ...
 *
 */
public class SimplifyGraphMapper extends Mapper<Object, Text, Membership, RepresentativeEdge> {
	...
	@Override
	public void map(Object key, Text description, Context ctx) throws IOException, InterruptedException {
