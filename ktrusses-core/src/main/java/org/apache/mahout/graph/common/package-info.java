 ...
 * 	<li>Augment the graph with vertex degrees using {@link org.apache.mahout.graph.common.AugmentGraphWithDegreesJob} which can be achieved in a  two-step MapReduce
 * 		pipeline.</li>
 * </ol>
 */
